            ...
            <div className="w-full flex flex-col gap-5 justify-center items-start rounded-md border border-gray-300 p-8">
                ...
                <div className="w-full flex flex-col grow gap-2">
                    ...
                    <div className="relative w-full">
                        ...
                        <input type="text" className="h-8 w-full p-5 focus:outline-none border-none caret-slate-500 rounded-sm text-slate-900 bg-input hover:bg-secondary-20 focus:bg-secondary-20" />
                    </div>
